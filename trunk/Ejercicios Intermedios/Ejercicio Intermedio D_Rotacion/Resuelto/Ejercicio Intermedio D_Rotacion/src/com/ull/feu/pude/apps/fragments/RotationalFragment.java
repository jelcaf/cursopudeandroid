...
public class RotationalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Éste es un punto donde podemos operar sobre los datos que se encuentren dentro del savedInstanceState
        if (savedInstanceState != null) {
			if (savedInstanceState.getString("x") != null) 
				Log.i(LOG_TAG, "Valor de x almacenado en el Bundle = " + savedInstanceState.getString("x"));
		}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		// Éste es otro punto donde podemos operar sobre los datos que se encuentren dentro del savedInstanceState
	}
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
    	...
    	// Aquí podemos guardar variables y datos que nos hagan falta
    }
